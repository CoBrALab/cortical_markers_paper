...
% Spin BSC data
readleft = strcat(analysis_directory, 'lm_BSC_left_FDR.csv');
readright = strcat(analysis_directory, 'lm_BSC_right_FDR.csv');
...
readleft2 = strcat(analysis_directory, 'lm_GWC_left_FDR.csv');
readright2 = strcat(analysis_directory, 'lm_GWC_right_FDR.csv');
...
readleft1 = readleft;
readright1 = readright;
readleft2 = strcat(analysis_directory, 'lm_CT_left_FDR.csv');
readright2 = strcat(analysis_directory, 'lm_CT_right_FDR.csv');
...
readleft1 = readleft;
readright1 = readright;
readleft2 = strcat(analysis_directory, 'lm_t1t2_ratio_25_GM_left_FDR.csv');
readright2 = strcat(analysis_directory, 'lm_t1t2_ratio_25_GM_right_FDR.csv');
...
readleft1 = readleft;
readright1 = readright;
readleft2 = strcat(analysis_directory, 'lm_t1t2_ratio_50_GM_left_FDR.csv');
readright2 = strcat(analysis_directory, 'lm_t1t2_ratio_50_GM_right_FDR.csv');
...
readleft1 = readleft;
readright1 = readright;
readleft2 = strcat(analysis_directory, 'lm_t1t2_ratio_25_WM_left_FDR.csv');
readright2 = strcat(analysis_directory, 'lm_t1t2_ratio_25_WM_right_FDR.csv');
...
% Spin GWC data
readleft = strcat(analysis_directory, 'lm_GWC_left_FDR.csv');
readright = strcat(analysis_directory, 'lm_GWC_right_FDR.csv');
permno = 1000; % how many spins
...
% Spin CT data
readleft = strcat(analysis_directory, 'lm_CT_left_FDR.csv');
readright = strcat(analysis_directory, 'lm_CT_right_FDR.csv');
permno = 1000; % how many spins
...
readleft = strcat(analysis_directory, 'lm_t1t2_ratio_25_GM_left_FDR.csv');
readright = strcat(analysis_directory, 'lm_t1t2_ratio_25_GM_right_FDR.csv');
permno = 1000; % how many spins
...
readleft = strcat(analysis_directory, 'lm_t1t2_ratio_50_GM_left_FDR.csv');
readright = strcat(analysis_directory, 'lm_t1t2_ratio_50_GM_right_FDR.csv');
permno = 1000; % how many spins
