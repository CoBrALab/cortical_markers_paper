...
v_exclude_left = logical(load('../data/CIVET_2.0_mask_left_short_inv.txt')); % label of vertices in the medial wall is 1644825
...
z_data2_above = NaN(81924,1);
z_data2_inside = NaN(81924,1);
z_data2_below = NaN(81924,1);
...
xlabel(x_label,'FontSize', 25, 'Interpreter', 'none');
ylabel(y_label,'FontSize', 25, 'Interpreter', 'none');
title('');
legend('off')
